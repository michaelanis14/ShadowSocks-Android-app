...
import com.github.vpn247.acl.CustomRulesFragment
import com.github.vpn247.aidl.IShadowsocksService
import com.github.vpn247.aidl.ShadowsocksConnection
import com.github.vpn247.aidl.TrafficStats
import com.github.vpn247.bg.BaseService
import com.github.vpn247.bg.Executable
...
import com.github.vpn247.widget.ServiceButton
import com.github.vpn247.widget.StatsBar
...
class MainActivity : AppCompatActivity(), ShadowsocksConnection.Callback, OnPreferenceDataStoreChangeListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val firs = Core.currentProfile?.first
        if(firs?.host.isNullOrEmpty()){
            print(firs.toString())
        }
