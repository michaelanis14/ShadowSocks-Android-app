...
import com.github.vpn247.database.Profile
import com.github.vpn247.database.ProfileManager
import com.github.vpn247.plugin.PluginConfiguration
import com.github.vpn247.plugin.PluginContract
import com.github.vpn247.plugin.PluginManager
import com.github.vpn247.plugin.PluginOptions
import com.github.vpn247.preference.DataStore
import com.github.vpn247.preference.IconListPreference
import com.github.vpn247.preference.OnPreferenceDataStoreChangeListener
import com.github.vpn247.preference.PluginConfigurationDialogFragment
import com.github.vpn247.utils.Action
import com.github.vpn247.utils.DirectBoot
import com.github.vpn247.utils.Key
...
class ProfileConfigFragment : PreferenceFragmentCompat(),
    ...
    override fun onCreatePreferencesFix(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        if (Build.VERSION.SDK_INT >= 25 && activity.getSystemService<UserManager>()?.isDemoUser == true) {
            findPreference(Key.host).summary = "merply.com"
